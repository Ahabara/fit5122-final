...
const SuburbMap:React.FC<SuburbMapProps> = ({city}) => {
    ...
    return (
        <section>
            <div className="flex flex-col flex-wrap lg:py-6 mb-10  lg:text-left">
            ...
            <div className="text-gray-600 body-font relative ">
                <p>{cityURL}</p>
                <div className="absolute inset-0 bg-gray-300  border-2 hover:bg-opacity-0">
                    <iframe
                        width="100%"
                        height="100%"
